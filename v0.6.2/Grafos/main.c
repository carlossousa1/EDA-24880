...
#pragma region LISTA_ADJACENCIAS
	  ...
	  //======================================
	  //H1 - Estrutura de V�rtices Fixa
	  //======================================
	  int i,  b;

	  // Inicializa��o da lista de vertices
	  // Vertices: 0, 1, 2, 3...
	  ...
	  //======================================
	  //H2 - Grafo n�o orientado e pesado
	  //======================================
	  ...
	  printGraph(g);
	  printf("\nGrafo N�o Orientado\n");
	  // mostra a lista de adjac�ncias
	  printGraphWeight(g, true);

	  //Menor Dist�ncia saindo de um Vertice v

	  printf("\nMenor Dist�ncia saindo de (%d) = %2.0f\n", 2, ShorterDistance(g, 2));
