    ...
    */
        do
        {
                ...
                switch(opcao)
            {
                ...
                // Ler Aluguer - Listar Veiculos
                case 7:
                // esturuta case que disponibiliza diferentes funcionalidades.
                // Para veiculos: Listar autonomia de veiculos e localizacao geocodigo.
                // Para aluguer: Filtragem de alugueis por determinado veículo.
                        // veiculos
                    /*if(opcao2 == 1)
                    {
                        decrescenteVeiculos(array_veiculos, quant_veiculos);
                    }
                    else if(opcao2 == 3)
                    {
                        ...
                        if (veiculoAlugueis(array_alugueis, array_veiculos, quant_alugueis, quant_veiculos, opcao3) == 0)
                            printf("Nenhum veículo/aluguer com o ID correspondente!\n");
                    }
                    else
                        printf("Opcao inválida!\n");*/
                    break;

                // Veiculos por geocodigo (somente para veiculos(opcao 1))
                case 8:
                    /*if(opcao2 == 1)
                    {
                        printf("Geocódigo?\n");
                        ...
                        if (geocodigoVeiculos(array_veiculos, quant_veiculos, opcao4) == 0)
                            printf("Nenhum valor coincide!\n");
                    }
                    else
                        printf("Opcao inválida!\n");*/
                    break;
