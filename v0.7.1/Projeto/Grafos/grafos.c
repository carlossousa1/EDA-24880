...
void listarVeiculosNoRaio(struct node* grafo, Veiculos* Inicio, float clienteLat, float clienteLon, float raio, int cidadeAlvo) {
    ...
    while (verticeAtual != NULL) {
        ...
        if (verticeAtual->PtAdjacente != NULL && verticeAtual->PtAdjacente->PtDestino != NULL) {
            ...
            // Verifica se o veículo está dentro do raio de busca e pertence à cidade alvo
                ...
                if (!visitado[verticeAtual->ID] && distanciaAtual <= raio && verticeAtual->ID == geocode) {
    ...
    while (frente != tras) {
        ...
        while (adjacente != NULL) {
            ...
            if (noAdjacente->PtAdjacente != NULL && noAdjacente->PtAdjacente->PtDestino != NULL) {
                ...
                // Verifica se o veículo está dentro do raio de busca e pertence à cidade alvo
                    geocode = atoi(Inicio->geocode);
                    if (!visitado[noAdjacente->ID] && distanciaAtual <= raio && noAdjacente->ID == geocode) {
...
int main() {
    ...
    //calcularDistanciaVeiculos(novoGrafo, veiculos, 1);
    //buscarVerticesAlcance(novoGrafo, veiculos, 1, 1);
    //listarVeiculosPorRaio(veiculos, 20, 20, 100, 1);
    //listarVeiculosPorRaio(veiculos, 20, 20, 100);
    //listarVeiculosNoRaio(cliente, veiculos, 100, "1");
    listarVeiculosNoRaio(novoGrafo, veiculos, 10, 10, 100, 1);
